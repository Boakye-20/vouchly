    ...
    return (
        <div className="max-w-7xl mx-auto px-6 pt-4">
            <div className="flex justify-center">
                <h1 className="text-3xl md:text-4xl font-light tracking-tight text-gray-900 border-b-4 border-blue-600 inline-block pb-2 mb-8 text-center">Features</h1>
            </div>
            <div className="space-y-8 p-6">
                <p className="text-xl text-gray-600 text-center mt-4">Everything you need to find reliable study partners.</p>
