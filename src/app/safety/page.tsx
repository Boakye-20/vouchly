    ...
    return (
        <div className="space-y-8 p-6">
            <div className="text-center">
                <h1 className="text-4xl md:text-5xl font-light tracking-tight text-gray-900">Safety</h1>
                <p className="text-xl text-gray-600 mt-4">Your safety and privacy are our top priorities.</p>
            </div>
