    ...
    return (
        <div className="space-y-8 p-6">
            <div className="text-center">
                <h1 className="text-4xl md:text-5xl font-light tracking-tight text-gray-900">Community Guidelines</h1>
                <p className="text-xl text-gray-600 mt-4">Our standards for respectful and productive study sessions.</p>
            </div>
